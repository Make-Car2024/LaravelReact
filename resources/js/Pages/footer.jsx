        ...
        <div className="mx-auto w-full max-w-screen-xl px-4 py-8 lg:py-12">
            <div className="md:flex md:justify-between">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mb-8 md:mb-0">
                    <div>
                        <h2 className="mb-4 text-lg font-semibold text-gray-800 uppercase">Resources</h2>
                    ...
                    <div>
                        <h2 className="mb-4 text-lg font-semibold text-gray-800 uppercase">Follow Us</h2>
                        <ul className="space-y-2">
                            <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Facebook</a></li>
                    ...
                    <div>
                        <h2 className="mb-4 text-lg font-semibold text-gray-800 uppercase">Legal</h2>
                        <ul className="space-y-2">
                ...
                <div className="bg-blue-50 p-6 rounded-lg shadow-sm border border-blue-100">
                    <div className="text-center md:text-right">
                        <p className="text-sm text-blue-600 mb-1">VISITORS TODAY</p>
                        <div className="flex items-center justify-end">
                            <span className="text-3xl font-light text-gray-800 mr-2">24,668</span>
                            <span className="text-sm text-red-500">-30.76%</span>
                        </div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500">
                    © {new Date().getFullYear()} NIM 5302422043, 5302422045 UNNES
                </span>
