        ...
        <div className="flex space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
          ...
          <div className="relative">
            <button
              ...
              type="button"
              className="inline-flex h-10 w-10 items-center justify-center rounded-lg p-2 text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200"
              aria-label="Search"
            >
              <svg
                className="h-5 w-5"
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  {languages.map((language) => (
                    <li key={language.code}>
                      <button
                        onClick={() => {
                          alert(`Bahasa diubah ke ${language.name}`);
                          setIsLanguageOpen(false);
                        }}
                        className="flex w-full items-center rounded px-3 py-2 hover:bg-gray-100"
                      >
                        <span className="mr-2 text-xs uppercase">{language.code}</span>
                        {language.name}
                      </button>
                    </li>
                  ))}
          ...
          <ul className="mt-4 flex flex-col rounded-lg border border-gray-100 bg-gray-50 p-4 font-medium md:mt-0 md:flex-row md:space-x-8 md:border-0 md:bg-white md:p-0 rtl:space-x-reverse">
            ...
            <li>
              <a
                ...
                onClick="return smoothScroll('card')"
              >
                Berita
              </a>
            </li>
